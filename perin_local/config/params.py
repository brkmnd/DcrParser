...
class Params:
    ...
    def init_data_paths(self, base_dir: str):
        ...
        self.training_data = {
            ("dcr", "eng"): f"{base_dir}/2020/cf/training/dcr.mrp",
        ...
        self.validation_data = {
            ("dcr", "eng"): f"{base_dir}/2020/cf/validation/dcr.mrp",
        ...
        self.test_data = {
            ("dcr", "eng"): f"{base_dir}/2020/cf/evaluation/input.mrp",
        ...
        self.companion_data = {
            ("dcr", "eng"): f"{base_dir}/2020/cf/companion/combined_udpipe.mrp",
    ...
    def load(self, args):
        ...
        with open(args.config, "r", encoding="utf-8") as f:
            params = yaml.load(f,Loader=yaml.FullLoader) #changed - FullLoader to supress warning
